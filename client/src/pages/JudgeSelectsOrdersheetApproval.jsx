...
export default function JudgePendingOrdersheets() {
     ...
     useEffect(() => {
          ...
          apiGet("/api/ordersheets/pending")
               .then((data) => {
                    if (data.success) setOrdersheets(data.data || []);
                    setLoading(false);
               })
               .catch((err) => {
                    console.error("❌ Error loading Ordersheets:", err);
                    setLoading(false);
               });
          ...
          <div className="!w-full !min-h-screen !flex !flex-col ![background-color:#f8fafc] ![font-family:Inter,sans-serif]">
               ...
               <div className="!flex-1 !p-[20px] lg:!p-[40px]">
                    ...
                    <div className="!max-w-[1300px] !mx-auto !flex !items-center !gap-2 !mb-8 !text-[13px]">
                         ...
                         <span className="!text-gray-600 !font-semibold">Pending Ordersheets</span>
                    </div>

                    <div className="!max-w-[1300px] !mx-auto">
                         <div className="!mb-8">
                              <h1 className="!text-[1.8rem] !font-bold !text-[#2c3e50] !m-0">Ordersheet Review Queue</h1>
                              <p className="!text-gray-500 !mt-1">Review, edit, and formally seal judicial orders submitted for approval</p>
                         </div>
                                   ...
                                   <table className="!w-full !text-left">
                                        <thead>
                                             <tr className="!bg-gray-50/50 !text-gray-400 !text-[11px] !font-bold !uppercase !tracking-wider">
                                                  ...
                                                  <th className="!p-[18px]">Submitted By</th>
                                                  <th className="!p-[18px]">Date Submitted</th>
                                        ...
                                        <tbody className="!divide-y !divide-gray-50">
                                             {filteredOrdersheets.length === 0 ? (
                                                  <tr>
                                                       <td colSpan="5" className="!p-20 !text-center !text-gray-400 !italic">✅ No pending ordersheets found in your queue</td>
                                                  </tr>
                                             ) : (
                                                  filteredOrdersheets.map((t) => (
                                                       <tr key={t.case_id} className="hover:!bg-[#f8fafc] !transition-colors">
                                                            <td className="!p-[18px]">
                                                                 ...
                                                                 <div className="!inline-block !px-2 !py-0.5 !bg-indigo-50 !text-indigo-600 !rounded !text-[9px] !font-bold !uppercase !mt-1">{t.case_type}</div>
                                                            </td>
                                                            <td className="!p-[18px]">
                                                                 <div className="!font-bold !text-gray-700 !text-[13px]">{t.party1} <span className="!text-gray-300 !mx-1">vs</span> {t.party2}</div>
                                                            </td>
                                                            <td className="!p-[18px]">
                                                                 <div className="!text-[13px] !font-medium !text-gray-600">{t.submitted_by}</div>
                                                                 <div className="!text-[11px] !text-gray-400">Court Clerk / Stenographer</div>
                                                            </td>
                                                            <td className="!p-[18px]">
                                                                 <div className="!text-[13px] !font-bold !text-gray-700">{new Date(t.submitted_at).toLocaleDateString(undefined, { dateStyle: 'medium' })}</div>
                                                            ...
                                                            <td className="!p-[18px] !text-right !pr-[30px]">
                                                                 <button
                                                                      ...
                                                                      onClick={() => navigate("/judge-dashboard/review-ordersheet", { state: { selectedCase: t } })}
                                                                 >
                                                                      Review Document
                                                                 </button>
                                                            </td>
                                   ...
                                   {filteredOrdersheets.map((t) => (
                                        <div key={t.case_id} className="!bg-[#fcfcfc] !border !border-gray-100 !rounded-[20px] !p-6 !shadow-sm">
                                             <div className="!flex !justify-between !items-start !mb-4">
                                                  <div>
                                                       <div className="!text-[11px] !font-bold !text-indigo-600 !uppercase !tracking-widest">{t.case_code}</div>
                                                       <div className="!text-[16px] !font-black !text-[#2c3e50] !mt-1">{t.case_title}</div>
                                                  </div>
                                                  <div className="!px-2 !py-1 !bg-amber-50 !text-amber-700 !rounded !text-[10px] !font-bold !uppercase">Review</div>
                                             </div>
                                             <div className="!space-y-4 !mb-6">
                                                  <div className="!flex !items-center !gap-3">
                                                       <div className="!text-[18px]">📜</div>
                                                       <div>
                                                            <div className="!text-[10px] !text-gray-400 !uppercase !font-bold">Litigants</div>
                                                  ...
                                                  <div className="!flex !items-center !gap-3">
                                                       ...
                                                       <div>
                                                            <div className="!text-[10px] !text-gray-400 !uppercase !font-bold">Prepared By</div>
                                                  ...
                                                  <div className="!flex !items-center !gap-3">
                                                       <div className="!text-[18px]">🕒</div>
                                                       <div>
                                                            <div className="!text-[10px] !text-gray-400 !uppercase !font-bold">Sent On</div>
